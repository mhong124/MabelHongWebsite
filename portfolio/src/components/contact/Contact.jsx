    ...
    <footer id = "contact">
        ...
        <ul className = {styles.links}>
                <li className = {styles.link}>
                    <img src = {getImageUrl("hero/email.png")} alt = "Email Icon" height = "50" width = "50"></img>
                    <a href = "mailto:mabelg.hong@gmail.com" target="_blank">mabelg.hong@gmail.com</a>
                </li>
                <li className = {styles.link}>
                    <img src = {getImageUrl("contact/linkedin.png")} alt = "Linked Icon" height = "50" width = "50"></img>
                    <a href = "https://www.linkedin.com/in/mabel-hong/" target="_blank">linkedin.com/in/mabel-hong</a>
                </li>
                <li className = {styles.link}>
                    <img src = {getImageUrl("contact/github.png")} alt = "Github Icon" height = "50" width = "50"></img>
